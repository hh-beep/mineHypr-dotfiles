...
-- Fzf
keymap.set('n', '<C-f>', '<cmd>FzfLua files<CR>', { desc = 'Buscar arquivos com FZF' })
vim.api.nvim_set_keymap('n', '<C-f>', '<cmd>FzfLua files<CR>', {})


--  Documentations
vim.keymap.set("n", "<C-k>", vim.lsp.buf.hover, { desc = "Show documentation (hover)" })
